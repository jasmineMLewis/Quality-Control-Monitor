<%@ Page Title="Quality Control :: Dashboard" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/User.Master" CodeBehind="HousingSpecialistDashboard.aspx.vb" Inherits="QualityControlMonitor.CaseManagerDashboard" %>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="dashboardMiniBox">
                    <div class="thumbnail text-center">
                        ...
                        <div class="caption">
                            <h3> Review List</h3>
                            <p>Itemization of Housing Specialists' Errors by Client</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="dashboardMiniBox">
                    <div class="thumbnail text-center">
                        ...
                        <div class="caption">
                            <h3>Error Report</h3>
                            <p>Outstanding Housing Specialists' Errors via Comments</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="dashboardMiniBox">
                    <div class="thumbnail text-center">
                        ...
                        <div class="caption">
                            ...
                            <p> Perform Analysis of Housing Specialists' and Auditors Errors</p>
                        </div>
                    </div>
                </div>
            </div>
