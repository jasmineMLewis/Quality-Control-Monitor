<%@ Page Title="QC :: Port In" Language="vb" AutoEventWireup="false" MasterPageFile="~/FileDetails.master" CodeBehind="CreatePortIn.aspx.vb" Inherits="QualityControlMonitor.CreatePortIn" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="nestedContent" runat="server">
    <div class="row">
        <div class="col-lg-12 col-md-7">
            <div class="card">
                <div class="header">
                    <h4 class="title"> <i class="fa fa-ship" aria-hidden="true"></i> QC Review :: Port In</h4>
                    <hr />
                </div>
                <div class="content">
                 <form id="Form1" action="" method="post" runat="server">
                   <div class="text-center">
                        <%
                          ...
                          %>
                             <asp:Button ID="btnCompleteReview" runat="server" class="btn btn-info btn-fill btn-wd" Text="Complete Port In Review" />
                          <%
                                Else
                          %>
                           <asp:Button ID="btnUpdateReview" runat="server" class="btn btn-warning btn-fill btn-wd" Text="Resubmit Port In Review" />
                          <%
                          End If
                          connReview.Close()
                        %>
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="process">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-heading">
                                    <h4 class="panel-title">  <i class="fa fa-ship" aria-hidden="true"></i>  Port In </h4>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div id="portability">
                                        <h6>Portability
                                         &nbsp; &nbsp; &nbsp;
                                             <%
                                                If processes.Count > 0 Then
                                                     If processes.Contains("16") Then
                                                         Response.Write("<input type='checkbox' name='processPortability' checked='checked' />")
                                                     Else
                                                         Response.Write("<input type='checkbox' name='processPortability' />")
                                                     End If
                                                Else
                                                     Response.Write("<input type='checkbox' name='processPortability' />")
                                                End If
                                        ...
                                        <%
                                            conn.Open()
                                             Dim errorPortabilityID As Integer
                                             Dim detailsPortability As String
                                             Dim noticeTypePortability As String
                                             Dim statusPortability As String
                                             Dim errorStaffNamePortability As String
                                            Dim errorReviewTypeIDPortability As Integer
                                            Dim processPortabilityID As Integer
                                            
                                             Dim queryPortability As New SqlCommand("SELECT ErrorID, Details, Status, NoticeTypes.Notice, Users.FirstName + ' ' + Users.LastName AS ErrorStaffName, fk_ReviewTypeID, fk_ProcessTypeID FROM FileErrors INNER JOIN NoticeTypes ON FileErrors.fk_NoticeTypeID = NoticeTypes.NoticeTypeID INNER JOIN Users ON FileErrors.fk_ErrorStaffID = Users.UserID WHERE fk_FileID = '" & fileID & "' AND fk_ProcessTypeID = 16 ORDER BY NoticeTypes.Notice", conn)
                                             Dim readerPortability As SqlDataReader = queryPortability.ExecuteReader()
                                             If readerPortability.HasRows Then
                                                 While readerPortability.Read
                                                     errorPortabilityID = CStr(readerPortability("ErrorID"))
                                                     detailsPortability = CStr(readerPortability("Details"))
                                                     noticeTypePortability = CStr(readerPortability("Notice"))
                                                     statusPortability = CStr(readerPortability("Status"))
                                                     errorStaffNamePortability = CStr(readerPortability("ErrorStaffName"))
                                                    errorReviewTypeIDPortability = CStr(readerPortability("fk_ReviewTypeID"))
                                                    processPortabilityID = CStr(readerPortability("fk_ProcessTypeID"))
                                             %>
                                               <div class="col-md-2"> 
                                                <h6>Notice</h6>
                                                 <br />
                                                 <div class="form-group">
                                                     <input class="form-control border-input" disabled="disabled" value="<% Response.Write(noticeTypePortability) %>" type="text" />
                                                 </div>
                                               </div>
                                               <div class="col-md-4"> 
                                                <h6>Comments</h6>
                                            <br />
                                                <div class="form-group">
                                                 <textarea class="form-control border-input" rows="2" cols="10" disabled="disabled"><% Response.Write(detailsPortability)%></textarea>
                                            </div>
                                               </div>
                                               <div class="col-md-2"> 
                                                <h6>Staff</h6>
                                                <br />
                                                <div class="form-group">
                                                <input class="form-control border-input" disabled="disabled" value="<% Response.Write(errorStaffNamePortability) %>" type="text" />
                                            </div>
                                               </div>
                                               <div class="col-md-2"> 
                                                <h6>Status</h6>
                                                 <br />
                                                <div class="form-group">
                                                <input class="form-control border-input" disabled="disabled" value="<% Response.Write(statusPortability) %>"  type="text" />
                                                </div>
                                               </div>
                                               <div class="text-center">
                                                 <br /><br />
                                                 <a href="EditError.aspx?SessionUserID=<% Response.Write(sessionUserID) %>&FileID=<% Response.Write(fileID) %>&ErrorID=<% Response.Write(errorPortabilityID) %>&ReviewTypeID=<% Response.Write(errorReviewTypeIDPortability) %>&ProcessTypeID=<% Response.Write(processPortabilityID) %>" class="btn btn-warning btn-fill btn-wd">Edit</a>
                                                </div>
                                               <div class="clearfix"></div>
                                                 <br />
                                        <%
                                    ...
                                    End If
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <asp:DropDownList ID="NoticeTypePortability" runat="server" 
                                                    class="form-control border-input" DataSourceID="SqlNoticeTypePortability" 
                                                    DataTextField="Notice" DataValueField="NoticeTypeID">
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlNoticeTypePortability" runat="server" 
                                                    ConnectionString="<%$ ConnectionStrings:QualityControlMonitorConnectionString %>" 
                                                    SelectCommand="SELECT [NoticeTypeID], [Notice] FROM [NoticeTypes] WHERE [NoticeTypeID] = '1' OR [NoticeTypeID] = '2' OR [NoticeTypeID] = '4' ORDER BY [Notice] ASC">
                                                </asp:SqlDataSource>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <textarea class="form-control border-input" cols="4" name="commentPortability" placeholder="Comment"
                                                    rows="1"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <asp:DropDownList ID="CaseManagerPortability" runat="server" class="form-control border-input"
                                                          DataSourceID="SqlCaseManagerPortability" DataValueField="UserID" DataTextField="FullName"></asp:DropDownList>
                                                         <asp:SqlDataSource ID="SqlCaseManagerPortability" runat="server" ConnectionString="<%$ ConnectionStrings:QualityControlMonitorConnectionString %>"
                                                           SelectCommand="SELECT [UserID], [FirstName] + ' ' + [LastName] AS [FullName] FROM [Users] WHERE [fk_RoleID] = '3' OR [fk_RoleID] = '2' ORDER BY [FirstName] ASC">
                                                         </asp:SqlDataSource>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <asp:DropDownList ID="StatusPortability" class="form-control border-input" runat="server">
                                                 <asp:ListItem Text="Status" Value="Pending"></asp:ListItem>
                                                  <asp:ListItem Text="Pending" Value="Pending"></asp:ListItem>
                                                  <asp:ListItem Text="Complete" Value="Complete"></asp:ListItem>
                                                 </asp:DropDownList>
                                        ...
                                        <div class="text-center">
                                             <asp:Button ID="btnCreateProcessPortability" runat="server" class="btn btn-success btn-fill btn-wd" Text="Add" />
                                        </div>
                                        <div class="clearfix"> </div>
                                        <hr />
                                    </div>
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                                        <div class="panel-body">
                                           ...
                                           %>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <textarea class="form-control border-input" cols="4" name="commentLeasingPacketChecklist" placeholder="Comment" rows="1"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                           ...
                                           %>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <textarea class="form-control border-input" cols="4" name="commentUtilityAllowanceChecklist" placeholder="Comment" rows="1"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                           ...
                                           %>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <textarea class="form-control border-input" cols="4" name="commentHapContract" placeholder="Comment" rows="1"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                           ...
                                           %>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <textarea class="form-control border-input" cols="4" name="commentHudTenancyAddendum" placeholder="Comment" rows="1"></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
